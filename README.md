...
<img src="Deployments/x_Images/AzureVirtualDesktopDomainServicesAddOn.png" alt="Azure Virtual Desktop Azure Active Directory Domain Services Add-On" width="150">
Click the button below to deploy
