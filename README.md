...
<img src="Deployments/x_Images/AzureADDomainServices.png" alt="Azure AD Domain Services" width="150">
Click the button below to deploy
...
<img src="Deployments/x_Images/AzureADDomainServicesToolsVM.png" alt="Azure AD Domain Services Tools VM" width="150">
Click the button below to deploy
...
# [Azure Virtual Desktop for AD Directory Domain Services Add-On - ReadMe](https://github.com/elliottfieldsjr/KillerHomeLab-ARM/blob/comingsoon/Deployments/Deploy-Azure-Virtual-Desktop-AzureAD-DomainServices.md)
<img src="Deployments/x_Images/AzureVirtualDesktopAzureADDSAddOn.png" alt="Azure Virtual Desktop AzureAD Directory Domain Services Add-On" width="150">
Click the button below to deploy
