configuration PREPAREADEXCHANGE1911
{
   param
   (
    ...
    Node localhost
    {
        ...
        Script PrepareExchange2019AD
        {
            SetScript =
            {
                ...
                L:\Setup.exe /PrepareSchema /DomainController:"$using:dc1Name" /IAcceptExchangeServerLicenseTerms_DiagnosticDataOFF
                L:\Setup.exe /PrepareAD /on:"$using:ExchangeOrgName" /DomainController:"$using:dc1Name" /IAcceptExchangeServerLicenseTerms_DiagnosticDataOFF
